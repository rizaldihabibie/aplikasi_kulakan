...
public class PilihBarangController {
    ...
    private final PenjualanPage_newController penjualanPage;
    ...
    public PilihBarangController(PenjualanPage_newController penjualanPage){
    ...
    public void searchButton(java.awt.event.ActionEvent e){
       listBarang = barangService.findByName(pilihBarang.getNamaBarangField().getText());
       viewDataOnTable();
    }
}
