...
public class LoadingDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Sedang bekerja..");
        setMaximumSize(new java.awt.Dimension(163, 163));
        setMinimumSize(new java.awt.Dimension(163, 163));
        setPreferredSize(new java.awt.Dimension(163, 163));

        labelLoading.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        labelLoading.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelLoading.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplikasi/kulakan/images/ajax-loader.gif"))); // NOI18N
        labelLoading.setMaximumSize(new java.awt.Dimension(543, 132));
        labelLoading.setPreferredSize(new java.awt.Dimension(543, 132));
        getContentPane().add(labelLoading, java.awt.BorderLayout.CENTER);
